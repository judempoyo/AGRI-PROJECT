    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <div class="mt-2">
                ...
                <x-input-file id="avatar" type="file" accept="image/*" name="avatar" :value="old('avatar')" autofocus autocomplete="avatar" />
                <x-input-error :messages="$errors->get('avatar')" class="mt-2" />


            </div>
            <div class="shrink-0 mt-2 w-1/3 border ">
                <img class="w-50 min-h-48 object-cover rounded-full" src="" alt="Current profile photo" />
            </div>
