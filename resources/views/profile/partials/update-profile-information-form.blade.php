    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <div class="mt-2">
                ...
                <x-input-file id="avatar" type="file" accept="image/*" name="avatar" :value="old('avatar')" autofocus
                    autocomplete="avatar" />
                <x-input-error :messages="$errors->get('avatar')" class="mt-2" />


            </div>
            <div class="shrink-0 mt-2 w-1/3">
                <img class="rounded w-36 h-36" src="{{ asset('storage/'.Auth::user()->avatar) }}"
